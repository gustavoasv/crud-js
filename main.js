...
//     <td>${client.cidade}</td>
//     <button type="button" class="button green" id="editar-${index}">edit</button>
//     <button type="button" class="button red" id="exluir-${index}">excluir</button>
//   `;
...
// document.querySelector("#tbCliente").addEventListener("click", editDelete);
